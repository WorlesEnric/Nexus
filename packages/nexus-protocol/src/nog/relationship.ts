...
export function createRelationship(
  ...
  return {
    ...
    meta: {
      ...(options?.meta?.strength !== undefined && { strength: options.meta.strength }),
      ...(options?.meta?.confidence !== undefined && { confidence: options.meta.confidence }),
      ...(options?.meta?.auto !== undefined && { auto: options.meta.auto }),
      ...(options?.meta?.source !== undefined && { source: options.meta.source }),
      ...(options?.meta?.notes !== undefined && { notes: options.meta.notes }),
    },
