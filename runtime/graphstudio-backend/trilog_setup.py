"""
TriLog initialization for GraphStudio Backend

This module sets up OpenTelemetry and TriLog for the FastAPI application.
...
def initialize_trilog():
    ...
    Returns:
        Registry: The GraphStudio schema registry
    """
    ...
    resource = Resource.create({
        SERVICE_NAME: "graphstudio-backend",
...
def get_logger(name: str) -> TriLogLogger:
    ...
    Args:
        name: Logger name (e.g., "graphstudio.auth")
