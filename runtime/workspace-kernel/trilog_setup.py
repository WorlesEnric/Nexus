"""
TriLog initialization for Workspace Kernel

This module sets up OpenTelemetry and TriLog for the workspace-kernel service.
...
def initialize_trilog():
    ...
    print(f"  Service: workspace-kernel")
...
def get_logger(name: str) -> TriLogLogger:
    ...
    Args:
        name: Logger name (e.g., "workspace_kernel.panels")
