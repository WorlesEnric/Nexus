...
# ============================================
# Nexus Python - Cleanup All Resources
# ============================================
...
echo ""
echo -e "${YELLOW}Deleting all resources in nexus-python namespace...${NC}"

# Delete all resources in namespace
kubectl delete namespace nexus-python --wait=true
...
if [ "$delete_pv" = "yes" ]; then
    ...
    kubectl delete pvc --all -n nexus-python || true
