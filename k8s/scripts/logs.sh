...
# ============================================
# Nexus Python - View Service Logs
# ============================================
...
case $SERVICE in
    workspace-kernel)
        ...
        ;;
    graphstudio-backend|backend)
        RESOURCE_TYPE="deployment"
        RESOURCE_NAME="graphstudio-backend"
        ;;
    graphstudio-frontend|graphstudio|frontend)
        RESOURCE_TYPE="deployment"
...
CMD="kubectl logs -n nexus-python $RESOURCE_TYPE/$RESOURCE_NAME --tail=$TAIL"
